 ...
 * enablePerClusterTuning and enableFanControl in PServerDriver.getDefaultProfile(). Game pinning
 * remains opt-in even on tested devices because container/FEX affinity is workload-specific.
 */
